...
param (
 ...
 [Parameter(Mandatory = $False)] [String] $pattern = "vc_redist*.x64*exe", # should have 1 wild card and end with file extension
 ...
 [Parameter(Mandatory = $False)] [String] $sourceUrl = "https://download.microsoft.com/download/0/6/4/064F84EA-D1DB-4EAA-9A5C-CC2F0FF6A638/vc_redist.x64.exe"
 )
