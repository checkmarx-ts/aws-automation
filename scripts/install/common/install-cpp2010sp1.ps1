<#
.SYNOPSIS
Installs / Configures Microsoft Visual C++ 2010 Redistributable Package (x64)
...
param (
 ...
 [Parameter(Mandatory = $False)] [String] $sourceUrl = "https://download.microsoft.com/download/3/2/2/3224B87F-CFA0-4E70-BDA3-3DE650EFEBA5/vcredist_x64.exe"
)
