...
function Download() {
  $source_url = "https://download.microsoft.com/download/0/1/E/01E0D693-2B4F-4442-9713-27A796B327BD/SQLEXPR_x64_ENU.exe"
  log "Downloading from $source_url"
  Invoke-WebRequest -UseBasicParsing -Uri "$source_url" -OutFile (Join-Path $expectedPath "SQLEXPR_x64_ENU.exe")
  return (Join-Path $expectedPath "SQLEXPR_x64_ENU.exe")
}
